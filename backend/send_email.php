...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($subject && $message && mail($to, $subject, $message, $headers)) {
        echo '<p style="color:green;">Email sent successfully!</p>';
    } else {
        echo '<p style="color:red;">Failed to send email. Please check the details.</p>';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .form-group{margin-bottom:1rem;}label{display:block;margin-bottom:0.3rem;}input,textarea{width:100%;padding:0.5rem;}
...
<body>
    ...
    <div class="main-content">
        ...
        <h2>Send Email to <?php echo htmlspecialchars($app['full_name']); ?></h2>
        <form method="POST">
