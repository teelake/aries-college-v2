...
form.addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        if (data.success) {
                    // Show success message with email confirmation (Approach 2)
                    showMessage(data.message || 'Application submitted successfully! We have sent you an email with your application details and payment link. Please check your email to complete your payment.', 'success');
